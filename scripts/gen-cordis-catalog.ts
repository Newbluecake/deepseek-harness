...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  fs: 'filesystem.md',
  fileExplorer: 'filesystem.md',
  goals: 'goal.md',
  webAuth: 'web-server.md',
  terminalWeb: 'terminal.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WebGate:
    'admission seat registration contract is owned by packages/host/webserver/src/index.ts',
  WebAuthHandle:
    'request authentication Provider contract is owned by packages/host/webserver/src/index.ts',
  ListDirResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  ReadFileResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  GitStatusResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  FileDiffRequest: 'file-explorer Remote request is owned by packages/fs/file-explorer/README.md',
  FileDiffResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  GitLogResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  SearchFilesRequest: 'file-explorer Remote request is owned by packages/fs/file-explorer/README.md',
  SearchFilesResult: 'file-explorer Remote result is owned by packages/fs/file-explorer/README.md',
  TerminalWebSpawnRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebSpawnResult: 'terminal-web Remote result is owned by packages/terminal/terminal-web/README.md',
  TerminalWebWriteRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebSignalRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebResizeRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebKillRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebRenameRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebListResult: 'terminal-web Remote result is owned by packages/terminal/terminal-web/README.md',
  TerminalWebReadRequest: 'terminal-web Remote request is owned by packages/terminal/terminal-web/README.md',
  TerminalWebReadResult: 'terminal-web Remote result is owned by packages/terminal/terminal-web/README.md',
