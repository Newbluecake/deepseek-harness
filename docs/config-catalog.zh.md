...
来源：[`packages/host/web-auth/src/index.ts:68`](../packages/host/web-auth/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-file-explorer`（[`packages/client/ui-file-explorer/src/index.ts`](../packages/client/ui-file-explorer/src/index.ts)）
...
- `@deepseek-ai/dsh-file-explorer` — 需要 `fs` · `shell` · `sandboxPolicy`（[`packages/fs/file-explorer/src/index.ts`](../packages/fs/file-explorer/src/index.ts)）
...
- `@deepseek-ai/dsh-terminal-web` — 需要 `subprocess` · `sandboxPolicy`（[`packages/terminal/terminal-web/src/index.ts`](../packages/terminal/terminal-web/src/index.ts)）
